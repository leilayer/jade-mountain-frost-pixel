...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B1Yjx6sX.mjs");
...
var manifest = { "b24e52bd99937342d81617dfb5d70b0001898fdc43518bfea85aee64d9c055d8": {
	functionName: "scanReceipt_createServerFn_handler",
	importer: () => import("./scan-receipt-Gv31XhrH.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BdC77IrE.mjs").then((n) => n.t),
